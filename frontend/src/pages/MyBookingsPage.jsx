...
import { CalendarMonth, Cancel, CheckCircle, AccessTime, Bloodtype } from '@mui/icons-material';
...
const MyBookingsPage = () => {
  ...
  return (
    <Container maxWidth="lg" marginTop={4} sx={{ py: 4}}>
      <Box sx={{ mb: 4 , color: '#6a11cb' ,fontWeight: '900'}}>
        <Typography variant="h3" gutterBottom>My Appointments</Typography>
